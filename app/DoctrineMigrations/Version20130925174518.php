 ...
 */
class Version20130925174518 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE dan_game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, owners LONGTEXT NOT NULL COMMENT '(DC2Type:array)', thumbnail LONGTEXT NOT NULL, minPlayer INT NOT NULL, maxPlayers INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE dan_desire (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, game_id LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, note LONGTEXT DEFAULT NULL, reward INT DEFAULT NULL, INDEX IDX_BC88B6437E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DROP TABLE dan_game");
